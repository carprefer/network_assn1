...
ByteStream::ByteStream(const size_t capacity)  // constructor(don't know why these members should be initialized by
                                               // initializer list.(because of errors. find later)
